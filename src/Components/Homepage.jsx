    ...
    <>
        ...
        <main className=" py-16 sm:py-20 md:py-14 xl:p-10">
          <div className="flex flex-col gap-6 text-center sm:mt-10 lg:mt-28">
            ...
            <h3 className="text-md lg:text-3xl text-white font-bold shadow">
              Create custom designs from motivational quotes that are wearable and tappable.
            </h3>
          </div>
        </main>
      </section>
      ...
      <section className="grid md:grid-cols-2 lg:grid-cols-2 text-cyan-900 gap-8 p-4 lg:p-20 place-items-center">
        <div className="flex flex-col gap-2 lg:gap-6">
          ...
          <div className="font-semibold text-justify lg:text-xl p-4 shadow-2xl lg:p-10 text-cyan-700">
            <h4>Amazing quotes are a fantastic way for high achievers to maintain self-control, to stay motivated, and to offer hope to those who are struggling.</h4>
            <span className="block mt-8 text-justify-center">... Anonymous</span>
          </div>
          <Link to="/getquotes">
            <button className="items-center text-cyan-100 font-bold list-none justify-self-end bg-cyan-700 md:w-25 lg:w-40 px-6 py-4 rounded-lg hover:scale-95">
              Get Quotes
            </button>
          </Link>
        </div>
      ...
      <section className="flex flex-col lg:mt-0 gap-5 p-4 lg:mx-16 rounded lg:p-20 text-white data-te-lazy-load-init background-motivas lg:hangerheight hanger">
        ...
        <div className="font-bold text-center lg:text-xl flex flex-col space-y-6 mx-auto lg:p-8 create">
          <h3 className="lg:w-3/4 lg:leading-[5rem] mx-auto shadow">
            Create personalized or generate regular quotes for your t-shirts or social media posts with Motiva, use them for your events, festivals, brand merchandise and more.
          </h3>
        </div>
        <Link to="/howitworks" className="mx-auto">
          <button className="text-cyan-100 text-center font-bold list-none justify-self-end bg-cyan-900 px-6 py-4 rounded-lg hover:scale-95">
            Get Your Motiva
          </button>
        </Link>
      </section>
